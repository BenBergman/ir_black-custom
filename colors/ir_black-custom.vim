...
let colors_name = "ir_black-custom"

"Had changed most/all black (specifically bg) to #121212 so borderless windows
"were better defined
...
hi NonText          guifg=#303030     guibg=black       gui=NONE      ctermfg=black       ctermbg=NONE        cterm=NONE
...
hi FoldColumn       guifg=#E18964     guibg=NONE        gui=NONE      ctermfg=white       ctermbg=NONE        cterm=NONE
...
hi Todo             guifg=white       guibg=#7C7C7C     gui=NONE      ctermfg=red         ctermbg=NONE        cterm=NONE
